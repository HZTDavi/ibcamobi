      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          <div className="flex items-center justify-center mb-4">
            <MapPin className="h-6 sm:h-8 w-6 sm:w-8 text-church-secondary mr-2 sm:mr-3" />
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="border-0 shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6 md:p-8 text-center">
              <p className="text-lg sm:text-xl mb-2">Av. João Machado Soares, 1010</p>
              <p className="text-lg sm:text-xl mb-2">Bairro Camobi</p>
              <p className="text-lg sm:text-xl mb-4 md:mb-6">Santa Maria - RS</p>
              
              <div className="rounded-lg overflow-hidden shadow-lg h-64 sm:h-80 md:h-96 mx-auto">
                <iframe
